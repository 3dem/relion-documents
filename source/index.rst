...
.. note::
    ...
    If |RELION| is useful in your work, please do make sure that our :doc:`Team <Team>` members are credited appropriately and cite `our papers <https://www2.mrc-lmb.cam.ac.uk/groups/scheres/publications.html>`_.

Table of Contents
-----------------

**These pages refer to RELION-5.0. At the moment, this document is incomplete and does not necessarily reflect all changes in RELION 5.0 yet.**
For RELION-4.0.x, please see `here <https://relion.readthedocs.io/en/release-4.0/>`_. 
